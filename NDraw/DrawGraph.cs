  ...
  public static partial class Draw
  {
    public static partial class Screen
    {
      ...
      public static void Graph(Rect graphRect, Rect unitRect, System.Func<float, float> func)
      {
        ...
        {
          var input = (-unitRect.x / unitRect.width) + (i / unitRect.width); // z + 
          var v0 = unitRect.y + (func.Invoke(input) * unitRect.height);

          v0 = Mathf.Clamp(v0,
              0,
              graphRect.height);

          var screeny1 = (int)(graphRect.y + v0);
          var screeny2 = (int)(graphRect.y + prev);
